 ...
 */
package de.featjar.todo.formula.configuration.list;
...
public class TWiseCoverageMetrics {
    ...
    public class TWiseCoverageMetric implements ISampleMetric {
        ...
        public double get(BooleanSolutionList sample) {
            ...
            final long numberOfValidConditions = statistic.valid();
            final long numberOfCoveredConditions = statistic.covered();
