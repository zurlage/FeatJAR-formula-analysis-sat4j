...
public class SingleCombinationSpecification implements ICombinationSpecification {
    ...
    public SingleCombinationSpecification(int[] literals, int t) {
        if (t < 1) {
    ...
    @Override
    public SingleCombinationSpecification forOtherT(int otherT) {
        return new SingleCombinationSpecification(literals, otherT);
    }
