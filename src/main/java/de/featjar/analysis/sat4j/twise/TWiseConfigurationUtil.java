...
//			localSolver.setSelectionStrategy(SStrategy.random());
	...
	public boolean select(TWiseConfiguration solution, TWiseConfigurationGenerator.Deduce deduce,
	...
	private void selectLiterals(TWiseConfiguration solution, TWiseConfigurationGenerator.Deduce deduce,
		LiteralList literals) {
